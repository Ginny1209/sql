...
SELECT 
    ...
    SUM(cp.quantity * cp.cost_to_customer_per_qty) AS sumspending
FROM 
    customer c
INNER JOIN 
...
*/
INSERT INTO temp.new_vendor (vendor_id, vendor_name, vendor_owner_first_name, vendor_owner_last_name)
